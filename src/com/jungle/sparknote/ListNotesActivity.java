...
public class ListNotesActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //listView.setSelector(Color.BLUE);
        Button buttonSave = (Button)findViewById(R.id.listsave);
...
//            SharedPreferences pref = getSharedPreferences("note-data",
//                    MODE_PRIVATE);
//            SharedPreferences.Editor editor = getSharedPreferences("note-map",
//                    MODE_PRIVATE).edit();
//            editor.putInt(String.valueOf(mAppWidgetId),i);
//            String text = pref.getString(String.valueOf(i),"");

                remoteViews.setTextViewText(R.id.textView3, text);

                //Intent intent1 = new Intent(context, ListNotesActivity.class);
                Intent intent1 = new Intent(context, EditNoteActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_SINGLE_TOP);
                //intent1.setAction(AppWidgetManager.ACTION_APPWIDGET_CONFIGURE);
                ...
                //intent1.setFlags(mAppWidgetId);
                Bundle pendBundle = new Bundle();
                pendBundle.putInt(AppWidgetManager.EXTRA_APPWIDGET_ID,mAppWidgetId);
